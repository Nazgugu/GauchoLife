...
-(void)drawRect:(CGRect)rect{
    ...
    CGContextSetStrokeColorWithColor(context,[UIColor yellowColor/*lightGrayColor*/].CGColor);
    CGContextBeginPath(context);
...
- (void)panGestureHandle:(UIPanGestureRecognizer *)recognizer
{
    ...
    if (recognizer.state == UIGestureRecognizerStateBegan) {
        ...
        if (isNeedPush && !self.revealing) {
            ...
            LMFeedCellDirection direct = _currentStatus==kFeedStatusLeftExpanding?LMFeedCellDirectionNone:LMFeedCellDirectionLeft;//Right;
            ...
            LMFeedCellDirection finalDir = LMFeedCellDirectionNone;//Right
            if (translation.x < 0)
                finalDir = LMFeedCellDirectionNone/*Left*/;
